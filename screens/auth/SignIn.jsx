...
export default function SignIn({ navigation }) {
  ...
  return (
    <SafeAreaView className="flex-1 flex-col justify-end">
      ...
      <View
        className={`${
          typingEmail || typingPassword ? "hidden" : "flex-1"
        } items-center justify-center bg-gray3`}>
        <ImageBackground
      ...
      <KeyboardAvoidingView
        ...
        className="flex flex-col p-8 space-y-4 bg-white">
        ...
        <TextInput
          ...
          onPressIn={() => setTypingEmail(true)}
          onBlur={() => setTypingEmail(false)}
        ...
        <TextInput
          ...
          onPressIn={() => setTypingPassword(true)}
